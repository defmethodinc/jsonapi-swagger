module Jsonapi
  class SwaggerAllGenerator < Rails::Generators::Base
    desc 'Create JSONAPI Swaggers for all Resources.'
    source_root File.expand_path('../swagger/templates', __dir__)

    def create_swagger_all_file
      ["V0::Admin", "V0::Batch"].each do |resource|
